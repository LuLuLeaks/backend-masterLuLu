        ...
        battleroyalenews: {
            news: {
                motds: [
                    {
                        entryType: "Text",
                        image: "https://i.imgur.com/opYD5ud.jpeg",
                        tileImage: "https://i.imgur.com/opYD5ud.jpeg",
                        hidden: false,
                        videoMute: false,
                        tabTitleOverride: "LuLuDEV",
                        _type: "CommonUI Simple Message MOTD",
                        title: "LuLuDEV",
                        body: "Welcome to LuLuDEV, a private server created by LeakerLuLu (@RealLuLu) & LeakerLuvo (@RealLuvo).",
                        videoLoop: false,
                ...
                messages: [
                    {
                        ...
                        subgame: "br",
                        title: "LuLuDEV",
                        body: "Credits: LuLu (@RealLuLu) and Levo (@RealLuvo)",
                        spotlight: true
                    }
                ]
            },
